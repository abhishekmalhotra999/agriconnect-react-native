...
export default function PrivacyPolicy() {
  // const privacyPolicy = useAppSelector(state => state.app.privacyPolicy);
  // const dispatch = useAppDispatch();
  // useEffect(() => {
  //   if (!privacyPolicy) {
  //     fetchPrivacyPolicy()
  //       .then(result => dispatch(appActions.savePrivacyPolicy(result)))
  //       .catch(console.log);
  //   }
  // }, [privacyPolicy]);
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollContainer}>
        {privacyPolicy && (
          <RenderHTML source={{html: privacyPolicy}} tagsStyles={tagsStyles} />
        )}
      </ScrollView>
    </View>
  );
